  ...
  const socials = [
    {
      name: 'GitHub',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 transform transition-transform duration-200 group-hover:scale-130 group-hover:text-blue-200" viewBox="0 0 16 16" fill="currentColor">
