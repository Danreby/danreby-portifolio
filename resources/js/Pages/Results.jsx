            ...
            <AuthenticatedLayout user={auth.user}>
                <div className="py-4">
                    <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        <div className={`bg-white w-full min-h-[80vh] border border-[2px] rounded-md shadow-lg p-4 flex items-center flex-col gap-1 ${wasDone ? 'border-green-500' : 'border-red-500'}`}>
